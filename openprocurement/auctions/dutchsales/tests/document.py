...
from openprocurement.auctions.dutchsales.models import DGF_PLATFORM_LEGAL_DETAILS_FROM
from openprocurement.auctions.dutchsales.tests.base import BaseAuctionWebTest,  test_financial_auction_data
